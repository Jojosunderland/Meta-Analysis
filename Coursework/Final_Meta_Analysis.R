...
ss_clean <- data[!is.na(data$spring_start), ] 
sc_clean <- data[!is.na(data$spring_comp), ] 
fs_clean <- data[!is.na(data$fall_start), ] 
fc_clean <- data[!is.na(data$fall_comp), ] 
...
# Add summary diamond of random effect model 
